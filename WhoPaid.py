...
# Our phone numbers
# TODO(wesleyk): Add roy and terrence, for now w = roy and b = terrence
w_number = "+15083337789"
b_number = "+14408290544"
...
def generateBalance():
        ...
        if(owes_dict['w']['b'] > 0):
                response += "r owes t: " + str(owes_dict['w']['b']) + "\n"
        if(owes_dict['w']['e'] > 0):
                response += "r owes e: " + str(owes_dict['w']['e']) + "\n"
        if(owes_dict['b']['w'] > 0):
                response += "t owes r: " + str(owes_dict['b']['w']) + "\n"
        if(owes_dict['b']['e'] > 0):
                response += "t owes e: " + str(owes_dict['b']['e']) + "\n"
        if(owes_dict['e']['w'] > 0):
                response += "e owes r: " + str(owes_dict['e']['w']) + "\n"
        if(owes_dict['e']['b'] > 0):
                response += "e owes t: " + str(owes_dict['e']['b']) + "\n"
