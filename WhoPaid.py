...
def parseSMS():
	...
	if (from_number == w_number):
		...
		if(pay_all):
			...
			response = "w paid " + str(amount) + "\n"
		else:
			payments.insert({"Amount":amount,"From":w,"To":body_array[1]})
			response = "w paid " + body_array[1] + " " + str(amount) + "\n"
	...
	# Brandon sent in message
		...
		if(pay_all):
			...
			response = "b paid " + str(amount) + "\n"
		else:
			payments.insert({"Amount":amount,"From":b,"To":body_array[1]})
			response = "b paid " + body_array[1] + " " + str(amount) + "\n"
	...
	# Eddie sent in message
		...
		if(pay_all):
			...
			response = "e paid " + str(amount) + "\n"
		else:
			payments.insert({"Amount":amount,"From":e,"To":body_array[1]})
			response = "e paid " + body_array[1] + " " + str(amount) + "\n"
